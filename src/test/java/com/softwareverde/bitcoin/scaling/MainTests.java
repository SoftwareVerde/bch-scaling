...
public class MainTests {
    protected List<Transaction> _createTransactions(final Long blockHeight) throws Exception {
    ...
    public void foo() throws Exception {
        ...
        final byte[] bytes = IoUtil.getFileContents(new File("/Users/green/development/bch-scaling/out/data/blocks/default/000000000013C0D34E8D785DFB5FD2DCF186EACD5E47C33161FAF339067B4BBE"));
        System.out.println(bytes.length);
        final BlockInflater blockInflater = new BlockInflater();
        final Block block = blockInflater.fromBytes(bytes);

        final Transaction transaction = block.getCoinbaseTransaction();
        final UnlockingScript unlockingScript = transaction.getTransactionInputs().get(0).getUnlockingScript();
        System.out.println(unlockingScript.toJson());
    }
}
